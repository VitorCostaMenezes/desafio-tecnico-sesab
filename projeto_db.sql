...
(52, '2025_01_11_142835_create_personal_access_tokens_table', 1),
(53, '2025_01_11_160201_create_adresses_table', 1),
(54, '2025_01_11_161536_create_relations_table', 1);
...
--
-- Estrutura para tabela `relations`
--
...
ALTER TABLE `adresses`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `adresses_logradouro_unique` (`logradouro`),
  ADD UNIQUE KEY `adresses_cep_unique` (`cep`);
...
--
-- Índices de tabela `relations`
--
ALTER TABLE `relations`
  ADD PRIMARY KEY (`id`),
  ADD KEY `relations_adress_id_foreign` (`adress_id`),
...
--
-- Restrições para tabelas `relations`
--
ALTER TABLE `relations`
  ADD CONSTRAINT `relations_adress_id_foreign` FOREIGN KEY (`adress_id`) REFERENCES `adresses` (`id`),
  ADD CONSTRAINT `relations_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
